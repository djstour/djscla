...
function slimActivityForList(activity) {
  ...
  return {
    ...
    fromPrice: activity.fromPrice || null,
    priceDisplay: activity.priceDisplay || null,
    priceUnverified: activity.priceUnverified === true,
    ...
    // Required for zh catalog gate (isDisplayableTranslation) after list slimming.
    translationDisplay: activity.translationDisplay || null,
    translationUnverified: activity.translationUnverified === true,
